...
/**
 * 在 CefApp 初始化的早期阶段向 CEF（以及所有子进程）注册 "mod" 自定义 scheme。
 * <p>
 *
...
public class ModSchemeCefAppHandler extends CefAppHandlerAdapter {
    ...
    public void onRegisterCustomSchemes(CefSchemeRegistrar registrar) {
        ...
        //
        // "mod://" 与 "resource://" 都是"类 file" 的本地资源协议，参数相同：
        ...
        boolean modRegistered = registrar.addCustomScheme(
            "mod",
            true, // isStandard
            true, // isLocal
        ...
        LOGGER.info("[ModScheme] registrar.addCustomScheme(\"mod\", ...) -> " + modRegistered);

        boolean resourceRegistered = registrar.addCustomScheme(
            "resource",
            true, // isStandard
            true, // isLocal
            false, // isDisplayIsolated
        ...
        LOGGER.info("[ModScheme] registrar.addCustomScheme(\"resource\", ...) -> " + resourceRegistered);
    }
}
